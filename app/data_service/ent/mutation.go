...
func (m *AnnouncementMutation) AddAuthorIDs(ids ...int64) {
	if m.author == nil {
...
func (m *AnnouncementMutation) RemoveAuthorIDs(ids ...int64) {
...
func (m *AnnouncementMutation) RemovedAuthorIDs() (ids []int64) {
